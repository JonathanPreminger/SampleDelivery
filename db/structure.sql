...
CREATE TABLE IF NOT EXISTS "realreleases" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" text, "tracks" text, "year" text, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "artist_id" integer);
